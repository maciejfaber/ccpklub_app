# Generated by Django 3.2.23 on 2023-11-28 11:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(choices=[('PL', 'Polska'), ('CZ', 'Czech Republic'), ('SK', 'Slovakia'), ('UA', 'Ukraine'), ('SE', 'Sweden'), ('DK', 'Denmark'), ('FI', 'Finland'), ('NO', 'Norway'), ('GB', 'Great Britain'), ('DE', 'Germany'), ('NL', 'Netherlands'), ('FR', 'France'), ('CH', 'Switzerland'), ('BE', 'Belgium'), ('AT', 'Austria'), ('IT', 'Italy'), ('ES', 'Spain'), ('PT', 'Portugal'), ('IE', 'Ireland'), ('SI', 'Slovenia'), ('HU', 'Hungary'), ('USA', 'USA'), ('CA', 'Canada'), ('AU', 'Australia'), ('NZ', 'New Zealand')], max_length=20)),
