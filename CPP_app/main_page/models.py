...
class Pig(models.Model):
    ...
    owner = models.ManyToManyField('User', blank=True, default=None, related_name="PIG_owner")
...
class Rating(models.Model):
    ...
    exhibition_id = models.ForeignKey('Exhibition', null=True, blank=True, related_name='Rating_exhibition', on_delete=models.PROTECT)
    catalog_number = models.PositiveIntegerField(null=True, blank=True)
    rating_pig = models.ForeignKey('Pig', null=True, blank=True, related_name='Rating_pig', on_delete=models.PROTECT)
...
class Winners(models.Model):
    exhibition_id = models.ForeignKey('Exhibition', null=True, blank=True, related_name='Winners_exhibition', on_delete=models.PROTECT)
    best_in_show_b_c_1 = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_BISBC1', on_delete=models.PROTECT)
    best_in_show_b_c_2 = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_BISBC2', on_delete=models.PROTECT)
    best_in_show_b_c_3 = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_BISBC3', on_delete=models.PROTECT)
    best_in_show_baby_1 = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_BISB1', on_delete=models.PROTECT)
    best_in_show_baby_2 = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_BISB2', on_delete=models.PROTECT)
    best_in_show_baby_3 = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_BISB3', on_delete=models.PROTECT)
    best_in_show_junior_1 = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_BISJ1', on_delete=models.PROTECT)
    best_in_show_junior_2 = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_BISJ2', on_delete=models.PROTECT)
    best_in_show_junior_3 = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_BISJ3', on_delete=models.PROTECT)
    best_in_show_adult_1 = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_BISA1', on_delete=models.PROTECT)
    best_in_show_adult_2 = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_BISA2', on_delete=models.PROTECT)
    best_in_show_adult_3 = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_BISA3', on_delete=models.PROTECT)
    best_in_show_senior_1 = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_BISS1', on_delete=models.PROTECT)
    best_in_show_senior_2 = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_BISS2', on_delete=models.PROTECT)
    best_in_show_senior_3 = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_BISS3', on_delete=models.PROTECT)
    best_of_best_1 = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_BOB1', on_delete=models.PROTECT)
    best_of_best_2 = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_BOB2', on_delete=models.PROTECT)
    best_of_best_3 = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_BOB3', on_delete=models.PROTECT)
    pwcc_winner = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_PWCC', on_delete=models.PROTECT)
    pwsc_winner = models.ForeignKey('Pig', null=True, blank=True, related_name='Winners_PWSS', on_delete=models.PROTECT)
    best_of_breed = models.ManyToManyField('Bob', blank=True, related_name="Winners_bob")


class Bob(models.Model):
    winners_id = models.ForeignKey('Winners', null=True, blank=True, related_name='Bob_winners', on_delete=models.PROTECT)
    breed = models.ForeignKey('Breed', null=True, blank=True, related_name='Bob_breed', on_delete=models.PROTECT)
    best_of_breed = models.ForeignKey('Pig', null=True, blank=True, related_name='Bob_bob', on_delete=models.PROTECT)
    best_of_breed_baby = models.ForeignKey('Pig', null=True, blank=True, related_name='Bob_bobb', on_delete=models.PROTECT)
    best_of_breed_junior = models.ForeignKey('Pig', null=True, blank=True, related_name='Bob_bobj', on_delete=models.PROTECT)
    best_of_breed_adult = models.ForeignKey('Pig', null=True, blank=True, related_name='Bob_boba', on_delete=models.PROTECT)
...
class Exhibition(models.Model):
    ...
    rating = models.ManyToManyField('Rating', blank=True, related_name="Exhibition_rating")
    #winners
...
class ExhibitionGroup(models.Model):
    ...
    type = models.CharField(max_length=255, choices=TYPE_CHOICES, default='normal')
    exhibitions = models.ManyToManyField("Exhibition", blank=True, related_name="Group_exhibitions")
    winner = models.ForeignKey('Pig', null=True, blank=True, related_name='Group_winner', on_delete=models.PROTECT)
    start_date = models.DateField(null=True, blank=True)
    end_date = models.DateField(null=True, blank=True)
