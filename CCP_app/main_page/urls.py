...
urlpatterns = [
    ...
    path('member_register/', views.MemberRegisterView.as_view(), name='member_register'),
    path('exhibitor_register/', views.ExhibitorRegisterView.as_view(), name='exhibitor_register'),
    ...
    path('message/<int:message_id>/', views.ReplyOrDetailMessageView.as_view(), name='reply_or_detail_message'),
    # exhibitors pigs
    path('exhibitor/add_pig/', views.exhibitor_add_pig, name='exhibitor_add_pig'),
    path('exhibitor/my_pigs/', views.ExhibitorMyPigsView.as_view(), name='exhibitor_my_pigs'),
    path('exhibitor_pig_detail/<int:pig_id>/', views.ExhibitorPigDetailView.as_view(), name='exhibitor_pig_detail'),
    # breeder pigs
    ...
    path('breeder_pig_detail/<int:pig_id>/', views.BreederPigDetailView.as_view(), name='breeder_pig_detail'),
